...
package com.eng.game.pathfinding.pathfinding.util;
...
public class ObjectIntMap<K> implements Iterable<ObjectIntMap.Entry<K>> {
    ...
    private Entries<K> entries1;
    private Entries<K> entries2;
    private Values values1, values2;
    private Keys<K> keys1;
    private Keys<K> keys2;
...
//            switch (MathUtils.random(2)) {
    ...
    static public class Entries<K> extends MapIterator<K> implements Iterable<Entry<K>>, Iterator<Entry<K>> {
        ...
        public Entry<K> next() {
            ...
            if (!valid) throw new PathFindingException("#iterator() cannot be used nested.");
            K[] keyTable = map.keyTable;
