...
public class WinMenu implements Screen {
    ...
    public void render(float delta) {
        ...
        font.draw(game.batch, "You Win", backgroundx / 2 - 75, backgroundy / 10 * 8);
        font.draw(game.batch, "Your score is: " + score, backgroundx / 3, backgroundy / 10 * 7);
        font.draw(game.batch, "Press Space to return to the main menu", backgroundx / 11, backgroundy / 10 * 5);
        game.batch.end();

        score += Play.player.coins * 1000;
